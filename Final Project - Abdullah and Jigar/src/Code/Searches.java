...
/**
 * The Class Searches. This is a test method for searches for basic testing. A working search method is implemented in the loadViewStudent class.
 * 
...
public class Searches {
	...
	/**
	 * Binary search.(Note: This is just a test method. A working copy of this method has been re-used in the loadViewStudent class)
	 *
	 * @param studentHashMap the student hash map
	 * @param keyId the key id
	 * @param keyStart the key start
	 * @param high  the high
	 *           
	 */
	...
	/**
	 * Linear search. (Note: This is just a test method. A working copy of this method has been re-used in the loadViewStudent class)
	 *
	 * @param studentHashMap the student hash map
	 * @param keyId the key id
	 */
