...
/**
 * The Class loadAddStudent defines the layout that adds students to the database (Student HashMap)
 * 
...
public class loadAddStudent {
	 ...
	 * 
	 * @param studentMap the Student HashMap
	 */
	...
	private void initialize() {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] { "Freshman", "Sophomore", "Junior", "Senior" })); //Combobox for selecting the year
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//Checks if any field is empty. If any field is empty then the textfield(s) become red
